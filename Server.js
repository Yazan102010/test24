...
// Middleware
app.use(cors({
    origin: '*', // للسماح بكل المصادر
    methods: ['GET', 'POST', 'DELETE', 'PUT'], // السماح بكل أنواع الطلبات
    credentials: false, // تعيينها إلى false مؤقتاً إذا كنت لا تستخدم الـ credentials
}));
